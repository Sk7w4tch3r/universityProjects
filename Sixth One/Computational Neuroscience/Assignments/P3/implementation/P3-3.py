...
inhibition_layer = NeuronGroup(1,  eqs, threshold='v>=firing_threshold', reset='v=v_reset', method='linear')
...
inh_out_synapse = Synapses(inhibition_layer, output_layer, '''
            w : 1
            dapre/dt  = -apre /taupre  : 1 (event-driven)
            dapost/dt = -apost/taupost : 1 (event-driven)
            ''',
