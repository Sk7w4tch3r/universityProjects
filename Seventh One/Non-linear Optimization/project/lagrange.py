# -----------------------------------------------------------
# (C) 2021 SBU, Non-Linear Programming Course
...
def lagrangianOptimizer(fun, sbls, constraints):
    ...
    hessian_matrix = hessian(lagrangian, x)
    ...
    # sub = 3
    # hessian_matrix.minor_submatrix()
    # len()
    # print(f'minor {sub}th: {hessian_matrix.minor_submatrix(sub, sub)}')
...
if __name__ == "__main__":
    ...
    cons = [constraint_1([x1, x2, x3, x4]), constraint_2([x1, x2, x3, x4])]

    print(lagrangianOptimizer(function([x1,x2]), 'x1 x2 x3 x4', cons))
